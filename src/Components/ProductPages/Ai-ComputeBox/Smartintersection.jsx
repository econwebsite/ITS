    ...
    <section className="smart-int-section">
      ...
      <div className="smart-int-container">
        <div className="smart-int-left">
          ...
          <p>
            With upgradeable AI frameworks, support for multi-sensor fusion 
            (radar, LiDAR, and cameras), and edge-to-cloud orchestration,
            the Rugged AI Vision Box delivers the compute backbone for 
            next-generation intelligent intersections — enabling safer,
            smarter, and more connected urban mobility.
          </p>
        </div>
