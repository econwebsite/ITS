...
const steps = [
  {
    ...
    text: 'Receives real-time signal phase data from the traffic controller, aligning capture logic with red signal duration.',
  ...
  },
  {
    ...
    text: 'When a vehicle crosses the stop line after the light turns red, integrated detection logic (vision + sensor) activates capture.',
  ...
  },
  {
    ...
    text: 'A sequence of frames is recorded before, during, and after the violation — providing context and legal defensibility.',
  ...
  },
  {
    ...
    text: 'AI performs license plate recognition, event validation, and classification directly on-device with minimal latency.',
  ...
  },
  {
    ...
    text: 'Images, timestamps, signal state, lane data, and recognition results are securely packaged for back-office enforcement workflows.',
    ...
    <section className="rlvd-how" id="how-it-works">
      <div className="rlvd-how__inner">
        <div className="rlvd-how__header">
          ...
          <h2 className="rlvd-how__title">How RLVD Works</h2>
        </div>
        ...
        <div className="rlvd-how__triggers">
          <span className="rlvd-how__triggers-label">External Triggers</span>
          <div className="rlvd-how__trigger-tags">
            {triggerTags.map((t) => (
              <div className="rlvd-trigger-tag" key={t.text}>
                {t.icon}
                {t.text}
              </div>
            ))}
